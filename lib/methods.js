...
module.exports = function(couch, http) {
var module = {};
...
exports._getUID = function(database, callback) {
...
exports._getDatabase = function(database, callback) {
	console.log(couch._host+":"+couch._port);
	return http.get("http://"+couch._host+":"+couch._port + "/" + database, function(res) {
		var b = '';
